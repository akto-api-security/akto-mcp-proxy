/**
 * @deprecated Use the new API instead. This interface will be removed in a future version.
 */
export interface IIngestDataRequestDeprecated {
  host: string;
  url: string;
  method: string;
...
/**
 * @deprecated Use the new API instead. This class will be removed in a future version.
 */
export class IngestDataRequestDeprecated implements IIngestDataRequestDeprecated {
  host: string;
  url: string;
  method: string;
  requestHeaders: Record<string, string>;
 ...
 * @deprecated Use the new API instead. This interface will be removed in a future version.
 */
export interface IngestDataResultDeprecated {
  success: boolean;
  message: string;
  captured: boolean;
}
...
/**
 * @deprecated Use the new API instead. This function will be removed in a future version.
 */
export function ingestDataDeprecated(
  ingestDataRequest: IngestDataRequestDeprecated,
  env: any,
  ctx: ExecutionContext
): IngestDataResultDeprecated {
  try {
...
function generateLogFromPayload(payload: IngestDataRequestDeprecated): string {
...
async function sendToQueue(logs: string, env: any): Promise<void> {
  try {
    ...
    await env.AKTO_TRAFFIC_QUEUE_IRONHEART_DEMO.send(messages);
